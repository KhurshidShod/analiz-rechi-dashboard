  ...
  return (
    <div className={styles.needs}>
      <div
        ...
        className={styles.needs_left}
      >
        <h1>Потребности</h1>
        <div className={styles.needs_left_tabs}>
          <button>Продажи</button>
          <button>Колл-центр</button>
        </div>
        <DiapazonComponent hasBackground={false} onReports={true} />
        <div className={styles.needs_left_search}>
        ...
        <div className={styles.needs_left_content}>
          <div className={styles.needs_left_content_group}>
            {reportsFakeData.map((report, index) => (
              <div
                key={index}
                className={styles.needs_left_content_group_el}
        ...
        <p
          ...
          className={styles.needs_left_nodata}
        >
      ...
      <div
        ...
        className={styles.needs_right}
      >
        <h1>Финансовая нагрузка и обязательства</h1>
        <div className={styles.needs_right_group}>
          <div className={styles.needs_right_group_date}>
            Дата создания: 04.11.2024
          </div>
          <div className={styles.needs_right_group_message}>
            <span>Клиент</span>
            <p>
